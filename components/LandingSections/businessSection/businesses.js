...
const Businesses = () => {
  return (
    <>
      <section className={`${businessStyles.main_container} d-flex align-items-center flex-column`} id="businesses">
        <h3>Our Businesses</h3>
        <p>
          In addition to meeting your construction needs, we also offer other valueable services which are affordable
          and cost friendly.
        </p>
        <section className={`container d-flex w-100 justify-content-center flex-wrap`}>
